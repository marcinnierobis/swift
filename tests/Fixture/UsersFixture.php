...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'new' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
        'last_activity' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'new' => 1,
                'last_activity' => '2021-09-06 17:15:10',
                'created' => 1630948510,
                'modified' => 1630948510,
            ],
        ];
